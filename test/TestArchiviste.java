...
public class TestArchiviste {
	...
	public void test1(){
		...
		Test.test(archiviste.getAssassine()==false, "test de l'initialisation de la variable \"assassine\"");
		Test.test(archiviste.getVole()==false, "test de l'initialisation de la variable \"vole\"");
	}
