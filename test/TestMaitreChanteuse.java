...
public class TestMaitreChanteuse {
	...
	public void test1(){
		...
		Maitre_Chanteuse mchanteuse = new Maitre_Chanteuse();
		...
		Test.test(mchanteuse.getAssassine()==false, "test de l'initialisation de la variable \"assassine\"");
		Test.test(mchanteuse.getVole()==false, "test de l'initialisation de la variable \"vole\"");
	}
}