...
public class TestCondottiere {
	...
	public void test2() {
		...
		q = new Quartier("hétel de ville",Quartier.TYPE_QUARTIERS[3],5); pioche.ajouter(q);
	...
	public void test3() {
		...
		Test.test(condottiere.getJoueur().nbPieces() == 3,
			"test du nombre de piéces d'or aprés perception de ressources spécifiques avec 1 quartier militaire");
	}
}
