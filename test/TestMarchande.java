...
public class TestMarchande {
	...
	public void test2(){
		...
		Test.test(marchande.getJoueur().nbPieces() == 4,
			"test du nombre de piéces d'or aprés perception de ressources spécifiques avec 2 quartiers commeréants");
		marchande.utiliserPouvoir();
		Test.test(marchande.getJoueur().nbPieces() == 5,
				"test du nombre de piéces d'or aprés utilisation du pouvoir");
