...
import modele.personnage.Patricien;
...
public class TestPatricien {
	...
	public void test3(){
		...
		Test.test(patricien.getAssassine() == true,"test de l'assassinat");
	}
	public void test4(){
		System.out.println("TEST DU VOL DU PERSONNAGE");
		Patricien patricien = new Patricien();
		patricien.setVole();
		Test.test(patricien.getVole() == true,"test du vol");
	}
	public void test5(){
	...
	public void test9(){
		...
		Test.test(patricien.getJoueur() == null,
				"test alors que le joueur n'est pas attribu�");
		patricien.setJoueur(joueur);
		Test.test(patricien.getJoueur().getPossedeCouronne() == false, "test avant utilisation");
		patricien.utiliserPouvoir();
		Test.test(patricien.getJoueur().getPossedeCouronne() == true, "test apr�s utilisation");
	}
	public void test10(){
		...
		Test.test(patricien.getAssassine() == false, "test de l'assassinat du personnage");
		Test.test(patricien.getVole() == false, "test du vol du personnage");
	}
}
