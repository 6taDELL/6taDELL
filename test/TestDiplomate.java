...
public class TestDiplomate {
    ...
    public void test3() {
        ...
        for(int i = 0; i< citeDiplo.length; i++)
            System.out.print(citeDiplo[i].getNom() + ", ");
            System.out.println("");

            System.out.print("Cite du roi (" + roi.getJoueur().getNom() + "): ");
        Quartier[] citeRoi = roi.getJoueur().getCite();
        for(int i = 0; i< citeRoi.length; i++)
            System.out.print(citeRoi[i].getNom() + ", ");
            System.out.println("");

            System.out.print("Cite de la Diplomate (" + assassin.getJoueur().getNom() + "): ");
        Quartier[] citeAssassin = assassin.getJoueur().getCite();
        for(int i = 0; i< citeAssassin.length; i++)
            System.out.print(citeAssassin[i].getNom() + ", ");
            System.out.println("");
