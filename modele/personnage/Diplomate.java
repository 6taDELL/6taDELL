...
public class Diplomate extends Personnage{
    ...
    public void utiliserPouvoir() {
            ...
            do{
                ...
                for(int i=0; i<joueurDiplo.nbQuartiersDansCite(); i++){
                ...
                if(oui && !(this.getJoueur().nbQuartiersDansCite()==0)){
                    ...
                    do {
                        ...
                        if(choix != -1){
                            ...
                            }else if(joueurChoisi.nbQuartiersDansCite() == 0){       // si choisit qqn qui n'a pas de quartiers bâtis
                                System.out.println("La personne choisie n'a pas de quartiers dans sa cité.");

                            }else if(joueurChoisi.nbQuartiersDansCite() == 8){
                ...
                }else if(this.getJoueur().nbQuartiersDansCite()==0){
                    ...
                    do {
                        ...
                        if(choix != -1){
                            ...
                            if(joueurChoisi.getPersonnage().getRang() == 8){      //si se choisit soit même
                                ...
                                int indxQuartierAdv = random.nextInt(joueurChoisi.nbQuartiersDansCite());
                                Quartier quartierAdv = joueurChoisi.getCite()[indxQuartierAdv];
                                boolean presentChezAdv = false;
                                for(int i=0; i<joueurChoisi.nbQuartiersDansCite();i++){
                                    if(quartierDiplo.getNom().equals(joueurChoisi.getCite()[i].getNom())){
